...
class gameGUI:
    ...
    def move(self, event):
        ...
        them.'''
        if event.keysym == 'w' or event.keysym == 'W' or event.keysym == 'Up': # If any of the keys pressed are these, then move object in the upward direction
            for Column in range(0, 4):
        ...
        self.afterMove() # Generates a random block of either 2 or 4 onto the grid
